...
@Component({
  selector: 'app-home',
  templateUrl: './teledisbuseddatalist.component.html',
})
export class TeleDisbursdatalistComponent  {
...
this.commonservice.getEnquiryDisburslistDetails(this.postsPerPage, this.currentPage,this.teleid);
this.commonservice
