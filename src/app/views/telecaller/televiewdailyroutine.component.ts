...
@Component({
  selector: 'app-home',
  templateUrl: './televiewdailyroutine.component.html',
//   styleUrls: ['./loantype.component.scss']
})
export class TeleDailyRoutineviewComponent{

  displayedColumns: string[] = ['date','company','bank','whosecase','comment'];
  samples:any;
  dataSource;
...
this.commonservice.viewTeleroutine(this.postsPerPage, this.currentPage,this.teleid);
this.commonservice
.viewTeleroutineDetails().subscribe((postData: {posts: SuperadminService[], postCount: number})=> {
...
editData1(id){
  console.log(id);
  this.commonservice.editBackend(id);
}
refresh(): void {
