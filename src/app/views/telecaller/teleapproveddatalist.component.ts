...
@Component({
  selector: 'app-home',
  templateUrl: './teleapproveddatalist.component.html',
})
export class TeleApproveddatalistComponent  {
...
this.commonservice.getEnquiryApprovedlist(this.postsPerPage, this.currentPage,this.teleid);
this.commonservice
