...
@Component({
  selector: 'app-home',
  templateUrl: './telerejectdatalist.component.html',
})
export class TeleRejectdatalistComponent  {
...
this.commonservice.getEnquiryRejectlist(this.postsPerPage, this.currentPage,this.teleid);
this.commonservice
