...
@Component({
  selector: 'app-home',
  templateUrl: './viewindileaveapp.component.html',
})
export class IndiLeaveApplistComponent  {
  ...
  ngOnInit() {
    ...
    this.isLoading = true;
    this.commonservice.getleavapp(this.postsPerPage, this.currentPage,this.empid);
    this.commonservice
      .getleavappDetails()
