...
@Component({
  selector: 'app-home',
  templateUrl: './viewindisugge.component.html',
})
export class IndiSuggestionlistComponent  {
 
  displayedColumns: string[] = ['name', 'mobile', 'email', 'bankname'];
  samples: any;
  dataSource;
  ...
  ngOnInit() {
    ...
    this.isLoading = true;
    this.commonservice.getsug(this.postsPerPage, this.currentPage,this.empid);
    this.commonservice
      .getsugDetails()
