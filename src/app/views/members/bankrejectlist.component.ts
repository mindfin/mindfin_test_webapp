...
@Component({
  selector: 'app-home',
  templateUrl: './bankrejectlist.component.html',
})
export class BankRejectListComponent {
  ...
  getreport(obj) {
    ...
    this.commonservice.getcaserejectlist(this.postsPerPage, this.currentPage, this.sdate, this.edate);
    this.commonservice
  ...
  exportAsXLSX(): void {
    ...
    var a;
    const fileName = "Bank Reject List "; 
