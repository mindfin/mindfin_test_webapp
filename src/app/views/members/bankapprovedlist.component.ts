...
@Component({
  selector: 'app-home',
  templateUrl: './bankapprovedlist.component.html',
})
export class BankApprovedListComponent {
  ...
  getreport(obj) {
    ...
    this.commonservice.getcaseapprovallist(this.postsPerPage, this.currentPage, this.sdate, this.edate);
    this.commonservice
  ...
  exportAsXLSX(): void {
    ...
    var a;
    const fileName = "Bank Approved List  "; 
