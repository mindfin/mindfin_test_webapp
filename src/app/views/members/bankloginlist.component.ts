...
@Component({
  selector: 'app-home',
  templateUrl: './bankloginlist.component.html',
})
export class BankLoginListComponent {
  ...
  getreport(obj) {
    ...
    this.commonservice.getcaseloginlist(this.postsPerPage, this.currentPage, this.sdate, this.edate);
    this.commonservice
  ...
  exportAsXLSX(): void {
    ...
    var a;
    const fileName = "Bank Login List "; 
