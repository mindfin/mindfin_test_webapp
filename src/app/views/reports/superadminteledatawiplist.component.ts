...
@Component({
  selector: 'app-home',
  templateUrl: './superadminteledatawiplist.component.html',
})
export class SuperAdminTeledataWIPlistComponent  {
...
empname:any;
  ngOnInit() {
    ...
    this.route.params.subscribe(params=>{
      ...
      this.commonservice.getEnquirywiplistexe1(this.postsPerPage, this.currentPage);
      this.commonservice
...
exportAsXLSX(): void {
  ...
  var a;
  const fileName = "Enquired WIP Data";
