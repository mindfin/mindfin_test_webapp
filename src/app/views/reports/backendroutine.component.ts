...
@Component({
  selector: 'app-home',
  templateUrl: './backendroutine.component.html',
})
export class BackendRoutineComponent {
  ...
  getreport(obj) {
    ...
    this.commonservice.getBackendroutinelist(this.postsPerPage, this.currentPage, this.sdate, this.edate);
    this.commonservice
